controllers.controller('twitterCtrl', function($scope, $ionicPlatform, $twitterApi, $cordovaOauth) {
  // 1
  ...
  $scope.toogleSocial = function(index){
    for(var i = 0; i < $scope.socialToogle.length; i++){
      $scope.socialToogle[i] = i == index;
    }
  };
